...
public class CruddemoApplication {
	...
	private void createMultipleStudents(StudentDAO studentDAO) {
		...
		Student tempStudent1 = new Student("amr", "amr", "amr@luv2code.com");
		Student tempStudent2 = new Student("abed", "abed", "abed@luv2code.com");
		Student tempStudent3 = new Student("aya", "aya", "aya@luv2code.com");
